...
/// A text component that displays text using the H1 typography style from the theme
///
/// H1Text automatically applies the h1 font family, weight, and color from the current theme,
...
///     .textColor(.blue)
/// ```
public struct H1Text: TextConfigurable, View {  // direct View listing — indirect (protocol-only) conformance composes empty under SkipUI (B1 P10/P11)
	...
	public var body: some View {
		let textStyle = theme.typography.textStyles.h1
