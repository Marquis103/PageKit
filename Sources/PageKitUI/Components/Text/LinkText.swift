...
/// A text component that displays text using the Link typography style from the theme
///
/// LinkText automatically applies the link font family, weight, and color from the current theme,
...
///     .textColor(.blue)
/// ```
public struct LinkText: TextConfigurable, View {  // direct View listing — indirect (protocol-only) conformance composes empty under SkipUI (B1 P10/P11)
	...
	public var body: some View {
		let textStyle = theme.typography.textStyles.link
