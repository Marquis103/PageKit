...
/// ```
public struct TextButton<T: ImageIconProtocol>: ButtonConfigurable, View {  // direct View listing — indirect (protocol-only) conformance composes empty under SkipUI (B1 P10/P11)
