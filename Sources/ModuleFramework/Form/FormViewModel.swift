...
///
/// FormViewModel extends ModuleViewModel with form-specific functionality
...
/// }
/// ```
class FormViewModel<Mod: Module>: ModuleViewModel<Mod> where Mod.ViewState: FormViewState {
	/// Typed access to the form view state
	var formViewState: Mod.ViewState {
		viewState
	}
