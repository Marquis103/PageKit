...
protocol CoordinatingHandoff where Self: Coordinator {
...
extension CoordinatingHandoff {
	// TODO: marquis need to figure out a way to orchestrate coordinatorWillStart and coordinatorDidStart for handoff
	func handoff(to step: HandoffStep, with action: NavigationAction) {
